...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    // add new vehicle to the end of the waiting line(queue)
    ...
    lck.lock();  //block the execution until the traffic light turns green.
    std::cout << "Intersection #" << _id << ": Vehicle #" << vehicle->getID() << " is granted entry." << std::endl;

    // If there is a read light, wait for a green 
